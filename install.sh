...
REPO_RAW="https://raw.githubusercontent.com/$GITHUB_USERNAME/bluesclaude/main"
CMD_NAME="bluesclaude"
BIN_DIR="${BLUESMINDS_BIN_DIR:-$HOME/.local/bin}"
